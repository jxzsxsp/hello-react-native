                ...
                <View>
                    <Image source={{ uri: 'http://img3.100bt.com/upload/ttq/20120908/1347116765019.jpg' }}
                        ...
                        <View style={{ flex:1,alignItems:'center', backgroundColor: 'rgba(0, 0, 0, 0.6)' }}>
                            ...
                            <View
                                style={{ width:140, marginLeft:40, marginTop:30, marginRight:40, flexDirection:'row', justifyContent:'space-between', alignItems:'center',   }}>
                                <Text style={{ fontSize:12, color:'#CECFCE',}}>420<Text style={{ color:'#3A87DF'}}>
                                    Foller</Text></Text>
                                <Text style={{ fontSize:12, color:'#CECFCE',}}>247<Text style={{ color:'#3A87DF'}}>
                                    Foller</Text></Text>
                            </View>
                        </View>
                    </Image>
          ...
          alignItems:'center',
                    ...
                    <View style={{ flexDirection:'row', height:80,   }}>
                        <View style={{ width:80, alignItems:'center' }}>
                            <View
                                style={{height:8, width:8, borderColor:'#F1A289',  borderWidth:2, borderRadius:4, marginTop:40 }}></View>
                            <View style={{flex:1, width:2, backgroundColor:'#DBDBDB'}}/>
                        </View>
                        <View style={{ justifyContent:'center'}}>
                            <Text style={{ color:'#8B8B8A', fontSize:14, marginBottom:5,  }}>Checked in at <Text
                                style={{color:'#C251C0'}}>Nola Bar and Restaurant</Text></Text>
                    ...
                    <View style={{ flexDirection:'row', height:80,   }}>
                        <View style={{ width:80, alignItems:'center' }}>
                            ...
                            <View
                                style={{height:8, width:8, borderColor:'#54D8E7',  borderWidth:2, borderRadius:4, }}></View>
                            <View style={{flex:1, width:2, backgroundColor:'#DBDBDB', overflow:'visible'}}/>
                        </View>
                        <View style={{ justifyContent:'center'}}>
                            <Text style={{ color:'#8B8B8A', fontSize:14, marginBottom:5,  }}>Hey team let us meet at
                                7:00 PM </Text>
                    ...
                    <View style={{ flexDirection:'row', }}>
                        <View style={{ width:80, alignItems:'center' }}>
                            <View style={{height:40, width:2, backgroundColor:'#DBDBDB', overflow:'visible'}}/>
                            <View
                                style={{height:8, width:8, borderColor:'#3885E5',  borderWidth:2, borderRadius:4,  }}></View>
                            <View style={{height:200, width:2, backgroundColor:'#DBDBDB', overflow:'visible'}}/>
                        </View>
                        <View >
                            <Text style={{ color:'#8B8B8A', fontSize:14, marginBottom:5, marginTop:20, }}>Bonfite with
                                friends </Text>
                            ...
                            <Image
                                ...
                                style={{ borderRadius:5, height:120, width:200}}/>
                        </View>
                    </View>
                </View>
            </ScrollView>
